...
Instructions::Instructions(std::string name)
	: Scene(name)
{
}

void Instructions::InitScene(float windowWidth, float windowHeight)
{
	...
	{
		//set the button for back button (3)
		auto collide = ECS::CreateEntity();
	...
	{
		//set the red hover effect for back button (4)
		auto collide = ECS::CreateEntity();
