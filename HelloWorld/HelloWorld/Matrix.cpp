...
{
	return ((row1.x * row2.y * row3.z) + (row1.y * row2.z * row3.x) + (row1.z * row2.x * row3.y) - (row1.z * row2.y * row3.x) - (row1.x * row2.z * row3.y) - (row1.y * row2.x * row3.z));
}
...
mat3 mat3::Inverse()
{
	...
	mat3 temp;
	temp.row1 = vec3(mat2(vec2(row2.y, row2.z), vec2(row3.y, row3.z)).Determinant(), -(mat2(vec2(row2.x, row2.z), vec2(row3.x, row3.z)).Determinant()), mat2(vec2(row2.x, row2.y), vec2(row3.x, row3.y)).Determinant());
	temp.row2 = vec3(-(mat2(vec2(row1.y, row1.z), vec2(row3.y, row3.z)).Determinant()), mat2(vec2(row1.x, row1.z), vec2(row3.x, row3.z)).Determinant(), -(mat2(vec2(row1.x, row1.y), vec2(row3.x, row3.y)).Determinant()));
	temp.row3 = vec3(mat2(vec2(row1.y, row1.z), vec2(row2.y, row2.z)).Determinant(), -(mat2(vec2(row1.x, row1.z), vec2(row2.x, row2.z)).Determinant()), mat2(vec2(row1.x, row1.y), vec2(row2.x, row2.y)).Determinant());
...
{
	float num1 = row1.x * row2.y * row3.z * row4.w;
	float num2 = row1.y * row2.z * row3.w * row4.x;
	float num3 = row1.z * row2.w * row3.x * row4.y;
	float num4 = row1.w * row2.x * row3.y * row4.z;

	float num5 = row1.w * row2.z * row3.y * row4.x;
	float num6 = row1.x * row2.w * row3.z * row4.y;
	float num7 = row1.y * row2.x * row3.w * row4.z;
	float num8 = row1.z * row2.y * row3.x * row4.w;
...
mat4 mat4::Inverse()
{
	...
	mat4 temp;
	temp.row1.x = mat3(vec3(row2.y, row2.z, row2.w), vec3(row3.y, row3.z, row3.w), vec3(row4.y, row4.z, row4.w)).Determinant();
	temp.row1.y = -(mat3(vec3(row2.x, row2.z, row2.w), vec3(row3.x, row3.z, row3.w), vec3(row4.x, row4.z, row4.w)).Determinant());
	temp.row1.z = mat3(vec3(row2.x, row2.y, row2.w), vec3(row3.x, row3.y, row3.w), vec3(row4.x, row4.y, row4.w)).Determinant();
	temp.row1.w = -(mat3(vec3(row2.x, row2.y, row2.z), vec3(row3.x, row3.y, row3.z), vec3(row4.x, row4.y, row4.z)).Determinant());

	temp.row2.x = -(mat3(vec3(row1.y, row1.z, row1.w), vec3(row3.y, row3.z, row3.w), vec3(row4.y, row4.z, row4.w)).Determinant());
	temp.row2.y = mat3(vec3(row1.x, row1.z, row1.w), vec3(row3.x, row3.z, row3.w), vec3(row4.x, row4.z, row4.w)).Determinant();
	temp.row2.z = -(mat3(vec3(row1.x, row1.y, row1.w), vec3(row3.x, row3.y, row3.w), vec3(row4.x, row4.y, row4.w)).Determinant());
	temp.row2.w = mat3(vec3(row1.x, row1.y, row1.z), vec3(row3.x, row3.y, row3.z), vec3(row4.x, row4.y, row4.z)).Determinant();

	temp.row3.x = mat3(vec3(row1.y, row1.z, row1.w), vec3(row2.y, row2.z, row2.w), vec3(row4.y, row4.z, row4.w)).Determinant();
	temp.row3.y = -(mat3(vec3(row1.x, row1.z, row1.w), vec3(row2.x, row2.z, row2.w), vec3(row4.x, row4.z, row4.w)).Determinant());
	temp.row3.z = mat3(vec3(row1.x, row1.y, row1.w), vec3(row2.x, row2.y, row2.w), vec3(row4.x, row4.y, row4.w)).Determinant();
	temp.row3.w = -(mat3(vec3(row1.x, row1.y, row1.z), vec3(row2.x, row2.y, row2.z), vec3(row4.x, row4.y, row4.z)).Determinant());

	temp.row4.x = -(mat3(vec3(row1.y, row1.z, row1.w), vec3(row2.y, row2.z, row2.w), vec3(row3.y, row3.z, row3.w)).Determinant());
	temp.row4.y = mat3(vec3(row1.x, row1.z, row1.w), vec3(row2.x, row2.z, row2.w), vec3(row3.x, row3.z, row3.w)).Determinant();
	temp.row4.z = -(mat3(vec3(row1.x, row1.y, row1.w), vec3(row2.x, row2.y, row2.w), vec3(row3.x, row3.y, row3.w)).Determinant());
	temp.row4.w = mat3(vec3(row1.x, row1.y, row1.z), vec3(row2.x, row2.y, row2.z), vec3(row3.x, row3.y, row3.z)).Determinant();
