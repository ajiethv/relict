...
unsigned int EntityIdentifier::m_barrierBit				= 0x2000;
...
unsigned int EntityIdentifier::VertiScrollCameraBit()
{
	return m_vertiScrollCameraBit;
}

unsigned int EntityIdentifier::BulletBit()
{
	return m_bulletBit;
}
...
unsigned int EntityIdentifier::BarrierBit()
{
	return m_barrierBit;
}
