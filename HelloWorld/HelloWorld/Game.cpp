...
bool Game::Run()
{
	...
	mciSendString("setvideo swing1 off", NULL, 0, 0);
	mciSendString("setaudio swing1 quality low", NULL, 0, 0);
	m_sound.push_back("play swing1 from 0");
	mciSendString("open assets\\music\\swing2.mp3 type mpegvideo alias swing2", NULL, 0, 0);
	mciSendString("setvideo swing2 off", NULL, 0, 0);
	mciSendString("setaudio swing2 quality low", NULL, 0, 0);
	m_sound.push_back("play swing2 from 0");
	mciSendString("open assets\\music\\clang1.mp3 type mpegvideo alias clang1", NULL, 0, 0);
	mciSendString("setvideo clang1 off", NULL, 0, 0);
	mciSendString("setaudio clang1 quality low", NULL, 0, 0);
	m_sound.push_back("play clang1 from 0");
	mciSendString("open assets\\music\\clang2.mp3 type mpegvideo alias clang2", NULL, 0, 0);
	mciSendString("setvideo clang2 off", NULL, 0, 0);
	mciSendString("setaudio clang2 quality low", NULL, 0, 0);
	m_sound.push_back("play clang2 from 0");
	mciSendString("open assets\\music\\clang3.mp3 type mpegvideo alias clang3", NULL, 0, 0);
	mciSendString("setvideo clang3 off", NULL, 0, 0);
	mciSendString("setaudio clang3 quality low", NULL, 0, 0);
	m_sound.push_back("play clang3 from 0");
	mciSendString("open assets\\music\\clang4.mp3 type mpegvideo alias clang4", NULL, 0, 0);
	mciSendString("setvideo clang4 off", NULL, 0, 0);
	mciSendString("setaudio clang4 quality low", NULL, 0, 0);
	m_sound.push_back("play clang4 from 0");
	mciSendString("open assets\\music\\clang5.mp3 type mpegvideo alias clang5", NULL, 0, 0);
	mciSendString("setvideo clang5 off", NULL, 0, 0);
	mciSendString("setaudio clang5 quality low", NULL, 0, 0);
	m_sound.push_back("play clang5 from 0");
	mciSendString("open assets\\music\\hit1.mp3 type mpegvideo alias hit1", NULL, 0, 0);
	mciSendString("setvideo hit1 off", NULL, 0, 0);
	mciSendString("setaudio hit1 quality low", NULL, 0, 0);
	m_sound.push_back("play hit1 from 0");
	mciSendString("open assets\\music\\hit2.mp3 type mpegvideo alias hit2", NULL, 0, 0);
	mciSendString("setvideo hit2 off", NULL, 0, 0);
	mciSendString("setaudio hit2 quality low", NULL, 0, 0);
	m_sound.push_back("play hit2 from 0");
	mciSendString("open assets\\music\\wavecomplete.mp3 type mpegvideo alias wavecomplete", NULL, 0, 0);
	mciSendString("setvideo wavecomplete off", NULL, 0, 0);
	mciSendString("setaudio wavecomplete quality low", NULL, 0, 0);
